...
NSArray *PerformXPathQuery(xmlDocPtr doc, NSString *query, xmlChar *nsPrefix, xmlChar *nsHref)
{
...
//    if(xmlXPathRegisterNs(xpathCtx, (const xmlChar *)@"a", (const xmlChar *)@"http://ec2.amazonaws.com/doc/2010-08-31/") != 0) {
...
//	}
	...
	for (NSInteger i = 0; i < nodes->nodeNr; i++)
	{
		...
		if (nodeDictionary)
		{
			[resultNodes addObject:[nodeDictionary valueForKey:@"nodeContent"]];
		}
	}
...
NSArray *PerformHTMLXPathQuery(NSData *document, NSString *query)
{
	...
	NSArray *result = PerformXPathQuery(doc, query, (xmlChar*)@"",(xmlChar*)@"http://ec2.amazonaws.com/doc/2010-08-31/");
    xmlFreeDoc(doc); 
...
{
    xmlDocPtr doc;
    NSString *str = [[[NSString alloc] initWithData:document encoding:NSUTF8StringEncoding] stringByReplacingOccurrencesOfString:@"xmlns=\"http://ec2.amazonaws.com/doc/2010-08-31/\"" withString:@""];
    document = [str dataUsingEncoding:NSUTF8StringEncoding];
